...
sed -i \
    -e 's#locks-core = { git = "https://github.com/pubky/locks.git", rev = "b3a054fcdfc5e4bc21b6daa2f9e48138bc6375c4" }#locks-core = { path = "/build/locks/locks-core" }#' \
...
sed -i \
    -e '/source = "git+https:\/\/github.com\/pubky\/locks.git?rev=b3a054fcdfc5e4bc21b6daa2f9e48138bc6375c4#b3a054fcdfc5e4bc21b6daa2f9e48138bc6375c4"/d' \
